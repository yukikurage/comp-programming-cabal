...
main :: IO ()
main = do
  xs <- VU.modify (VAM.sort) . fromBS <$> BS.readFile "/mnt/c/Users/yaman/Documents/CPCTF2021/sort.txt" :: IO (VU.Vector Int)
  writee xs
  return ()
...
writee xs
  | VU.null xs = return ()
  | otherwise = do
    appendFile "/mnt/c/Users/yaman/Documents/CPCTF2021/sorted.txt" $ show (VU.head xs)
    appendFile "/mnt/c/Users/yaman/Documents/CPCTF2021/sorted.txt" " "
    writee (VU.tail xs)
